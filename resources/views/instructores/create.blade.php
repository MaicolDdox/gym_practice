...
@section('content')
    @can('instructors.create')
        ...
        <!-- Modal -->
        <div class="modal fade" id="crearInstructorModal" tabindex="-1" aria-labelledby="crearInstructorModalLabel" aria-hidden="true">
                    ...
                    <div class="glass-effect rounded-2xl overflow-hidden shadow-2xl backdrop-blur-xl border border-gray-200/50">
                        ...
                        <div class="bg-gradient-to-r from-gray-100/80 to-purple-100/60 backdrop-blur-sm px-6 py-4 border-b border-gray-200/30">
                            <div class="flex items-center justify-between">
                                <h5 class="text-xl font-bold text-gray-800 font-[Space_Grotesk]">Crear Nuevo Instructor</h5>
                            ...
                            <form action="{{ route('instructors.store') }}" method="POST" class="space-y-6">
                                ...
                                <div class="text-center pt-4">
                                    <button type="submit"
                                        ...
                                        <i class="fas fa-save mr-2"></i> Guardar Instructor
                                    </button>
                                </div>
                            </form>
                        </div>
